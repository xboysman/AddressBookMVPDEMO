...
namespace AddressBookMVPDEMO
{
    public partial class Form_Person : Form, IPersonView
    {
        ...
        public string NameText { get => this.textBox_Name.Text; set => this.textBox_Name.Text = value; }
        public DateTime Birthday { get => this.dateTimePicker_Birthday.Value; set => this.dateTimePicker_Birthday.Value = value; }
        #endregion
